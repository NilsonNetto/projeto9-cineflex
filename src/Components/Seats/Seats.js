...
export default function Seats() {
  return (
    <div className='main'>
      ...
      <div className='seats'>
        {assentos.seats.map((seat) => (<div className='seat'> {seat.name} </div>))}
